...
import java.util.List;
 ...
 public class Delete_Bom_Page extends Page_Base{
   ...
   // public WebElement BOM_Name;
    ...
    public void Click_on_Check_Box(){Click_Button(Showing_Of_Status);}
    //public void Click_on_Yes(){Click_Button(Yes_Button);}

    public Delete_Bom_Page(WebDriver driver) { super(driver);
    }
    public void Deleting_Boms(WebDriver driver) throws InterruptedException {
        ...
        while (!(driver.findElement(By.xpath("//div[@class='actionbar-right mr-1']//span[2]")).getText()).equals("1")) {
            ...
            while (!driver.findElement(By.xpath("//table[@class='table table-bordered table-striped bg-white mt-05 mb-0']/tbody/tr[" + i + "]/td[2]/a[1]")).getText().equals("TAP_BOM_Proud_Test")) {
                if (Creat_Sub_Folder_Button.isDisplayed()){;
                    ...
                    while (staleElement2) {
                        ...
                        try {
                            ...
                            staleElement2 = false; }
                        catch (StaleElementReferenceException e) { staleElement2 = true; }
                    }
                    Thread.sleep(2000);
                ...
                else {System.out.println("Page has been Relaoded and redirected to Folder Page");}
            }
